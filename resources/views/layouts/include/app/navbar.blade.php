<nav class="navbar rounded shadow-sm border-bottom lh-1 py-3" style="background-color:#e3f2fd;">
    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ url('/') }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2L1 7l3.5 3.5L6 20l6-3 6 3-.5-9.5L22 7l-10-5z" />
            </svg>
                ...
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('about') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <path d="M11.414 2H20a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1h-6.586l-2.707 2.707A1 1 0 0 1 8 20V4a1 1 0 0 1 1.707-.707L11.414 2zM10 9H6v6h4V9zm2 0v6h4V9h-4zm2-7h-7a1 1 0 0 0-1 1v1h8V3zm-6 4H4v2h4V7zm2 0v2h4V7h-4z" />
                            </svg>
                            À Propos
                        </a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#">Signalement</a></li>
